...
angular.module('lacos')
  .controller('mesCtrl', function($scope, ngNotify, RestSrv, SERVICE_PATH ) {
    ...
    // Manage CRUD operations.
      var mUrl = SERVICE_PATH.PRIVATE_PATH  + '/mes';
    ...
    $scope.editMorador = function(m) {
      ...
      $scope.deleteModelo = function(m) {
          ...
          RestSrv.delete(mUrl, m, function() {
              ...
              ngNotify.set('Mes: \'' + m.mes + '\' Excluido com sucesso.', 'success');
    ...
    $scope.saveMorador = function(m) {
      ...
      if (m.id ) {
        ...
        RestSrv.edit(mUrl, m, function() {
          ...
          ngNotify.set('Mes: \'' + m.mes + '\' Alterado com sucesso.', 'failure');
        ...
        RestSrv.add(mUrl, m, function(newMorador) {
          ...
          $scope.hide();
          ngNotify.set('Mes: \'' + m.mes + '\' Salvo com sucesso.', 'success');
