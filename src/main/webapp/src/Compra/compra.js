...
angular.module('lacos')
  .controller('compraCtrl', function($scope, ngNotify, RestSrv, SERVICE_PATH ) {
    ...
    // Manage CRUD operations.
      var mUrl = SERVICE_PATH.PRIVATE_PATH  + '/compra';
    ...
    $scope.editMorador = function(m) {
      ...
      $scope.deleteModelo = function(m) {
          ...
          RestSrv.delete(mUrl, m, function() {
              ...
              ngNotify.set('Material: \'' + m.material + '\' Excluido com sucesso.', 'success');
    ...
    $scope.saveMorador = function(m) {
      ...
      if (m.id ) {
        ...
        RestSrv.edit(mUrl, m, function() {
          ...
          ngNotify.set('Material: \'' + m.material + '\' Alterado com sucesso.', 'failure');
        ...
        RestSrv.add(mUrl, m, function(newMorador) {
          ...
          $scope.hide();
          ngNotify.set('Material: \'' + m.material + '\' Salvo com sucesso.', 'success');
