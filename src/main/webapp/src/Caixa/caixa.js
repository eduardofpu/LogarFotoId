...
angular.module('lacos')
  .controller('caixaCtrl', function($scope, ngNotify, RestSrv, SERVICE_PATH ) {
    ...
    // Manage CRUD operations.
      var mUrl = SERVICE_PATH.PRIVATE_PATH  + '/caixa';
    ...
    $scope.editMorador = function(m) {
      ...
      $scope.deleteModelo = function(m) {
          ...
          RestSrv.delete(mUrl, m, function() {
              ...
              ngNotify.set('Total: \'' + m.total + '\' Excluido com sucesso.', 'success');
    ...
    $scope.saveMorador = function(m) {
      ...
      if (m.id ) {
        ...
        RestSrv.edit(mUrl, m, function() {
          ...
          ngNotify.set('Total: \'' + m.total + '\' Alterado com sucesso.', 'failure');
        ...
        RestSrv.add(mUrl, m, function(newMorador) {
          ...
          $scope.hide();
          ngNotify.set('Total: \'' + m.total + '\' Salvo com sucesso.', 'success');
